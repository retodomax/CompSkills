...
knitr::opts_chunk$set(comment = "",
                      tidy = TRUE,
                      tidy.opts = list(blank = FALSE, width.cutoff = 45),
                      fig.align = "left",
                      out.width = "100%",
                      fig.height = 5,
                      warning = FALSE,
...
The predictor year is highly significant with \Sexpr{format(summary(fit)$edf, digits = 4)} estimated degrees of freedom.
